...
F9_CD = 0.25; % https://space.stackexchange.com/questions/16883/whats-the-atmospheric-drag-coefficient-of-a-falcon-9-at-launch-sub-sonic-larg#16885
F9_A = pi * 2.6^2; % https://www.spacex.com/sites/spacex/files/falcon_users_guide_10_2019.pdf
...
for i = 1:steps
    y_drag(i) = calc_drag_earth(F9_CD, 0, x(i), F9_A);
end
